...
fn automatic_selection_bg(p: &Palette, host_theme: crate::terminal_theme::TerminalTheme) -> Color {
    ...
    // typical terminal themes (e.g. the Monokai kitty theme, in both light and
    // dark mode), keeping the highlight subtle enough to preserve foreground
    // legibility.
...
mod tests {
    ...
    fn selection_background_is_dark_gray_only_for_terminal_theme() {
        ...
        assert_eq!(other, automatic_selection_bg(&Palette::catppuccin(), host_theme));
