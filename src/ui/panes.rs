            ...
            for y in 0..inner.height {
                for x in 0..inner.width {
                    if sel.contains(y, x, scroll_metrics) {
                        ...
                        cell.set_style(selection_highlight_style(cell.style()));
                    }
                }
            }
        }
...
fn selection_highlight_style(cell_style: Style) -> Style {
    let mut style = Style::reset().bg(Color::DarkGray);
...
mod tests {
    ...
    #[test]
    fn selection_highlight_preserves_foreground_and_uses_dark_gray_background() {
        ...
        assert_eq!(second.add_modifier, Modifier::empty());
